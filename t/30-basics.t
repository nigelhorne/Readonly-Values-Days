...
subtest 'Short day names array' => sub {
	# Note: The module has a bug - it uses *shorten($*) instead of _shorten($_)
	# This test will currently fail until the module is fixed
	TODO: {
		local $TODO = "Module has syntax error in short_day_names definition";
...
subtest 'Day names to short hash' => sub {
	# Note: This will also fail due to the same syntax error
	TODO: {
		local $TODO = "Module has syntax error in day_names_to_short definition";
